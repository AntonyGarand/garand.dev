...
export const pagesConfig = {
	 ...
	 */
	notes: {
		title: "Notes - Quick thoughts and snippets",
		description:
			"Short notes and quick thoughts about interesting discoveries.",
		heading: "Notes",
		intro: "Quick notes and thoughts on things I find interesting.",
	},
	...
	uses: {
		...
		description:
			"A list of the tools, technologies, and environment I use for development work.",
		heading: "Setup",
		intro:
			"A look at the tools, technologies, and environment that power my development workflow.",
	},
	...
	contact: {
		...
		description:
			"Get in touch to discuss opportunities, collaborations, or technical challenges.",
		heading: "Let's Talk",
	},
} as const;
